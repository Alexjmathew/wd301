  ...
  return (
    <>
      ...
      <div className='flex p-2 m-5 justify-center gap-4'>
        <div className='border-2 border-slate-950 rounded-xl p-3 Pending' data-testid="pending">
        ...
        <div className='border-2 border-slate-950 rounded-xl p-3 Done' data-testid="done">
